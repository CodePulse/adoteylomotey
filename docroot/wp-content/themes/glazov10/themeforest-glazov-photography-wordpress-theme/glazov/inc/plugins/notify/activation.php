 ...
 */
require_once GLAZOV_FRAMEWORK . '/plugins/notify/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'glazov_register_required_plugins' );
 ...
 */
function glazov_register_required_plugins() {
	/*
    ...
    array(
	    'name'					=> 'Glazov Core',
	    'slug'     			=> 'glazov-core',
	    'source'				=> 'http://victorthemes.com/plugins/glazov-core.zip',
	    'required'			=> true,
    ...
    array(
	    ...
	    'required'			=> true,
	    'external_url'	=> 'https://wordpress.org/plugins/woocommerce-quantity-increment/',
    ),
    // WP-PageNavi
    array(
	    'name'					=> 'WP-PageNavi',
    ...
    array(
	    'name'					=> 'Zilla Likes',
	    'slug'     			=> 'zilla-likes',
	    'source'				=> 'http://victorthemes.com/plugins/zilla-likes.zip',
	    'required'			=> true,
	    'external_url'	=> 'http://www.themezilla.com/plugins/zillalikes/',
    ),
