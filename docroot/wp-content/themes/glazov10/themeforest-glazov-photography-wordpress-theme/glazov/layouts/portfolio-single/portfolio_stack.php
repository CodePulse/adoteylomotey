...
<div class="glzv-mid-wrap">
    <div class="mid-wrap-inner inner-space-tweleven">
      <div class="glzv-portfolio-detail portfolio-contained-stack">
        <?php if ($portfolio_single_width != 'fullwidth') {
          echo'<div class="container">';
        } ?>
          <div class="glzv-gallery glzv-lightgallery glzv-panr">
            <div class="glzv-masonry" data-item="1">
            <?php
            ...
            <div class="row">
              <div class="col-md-8 glzv-primary">
                <div class="primary-space">
                  <h2 class="portfolio-title"><?php echo esc_attr($portfolio_title); ?></h2>
                  <?php esc_attr(the_content()); ?>
                </div>
              </div>
              <div class="col-md-4 glzv-secondary glzv-sticky-sidebar">
