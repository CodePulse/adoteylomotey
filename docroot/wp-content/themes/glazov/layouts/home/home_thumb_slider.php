...
<div class="glzv-full-wrap">
  <div class="swiper-container galleryslides keyboard">
    ...
    if ( !empty( $gallery_imagess ) ) {
        ...
        <div class="swiper-slide">
          <div class="glzv-slide-wrap">
            <div class="glzv-background <?php echo esc_attr($image_media_class); ?>" style="background-image: url(<?php echo esc_url($imagess[0]); ?>);"></div>
            <?php if (!$hide_share) { ?>
...
<?php if($hide_next_prev == false){ ?>
  <div class="swiper-custom-controls">
    <div class="galley-toggle">
...
<?php } ?>
  ...
  <div class="swiper-container gallerythumbs keyboard" data-thumbs="false">
    <div class="swiper-wrapper">
    <?php if ( !empty( $gallery_imagess ) ) {
        ...
        if (!empty( $imagess )) {
          ...
          $imagess = GLAZOV_IMAGES.'/stack-placeholder.jpg';
        } ?>
      <div class="swiper-slide">
        <div class="glzv-slide-wrap">
          <div class="glzv-background" style="background-image: url(<?php echo esc_url($imagess[0]); ?>);"></div>
        </div>
      </div>
      <?php } } ?>
    </div>
